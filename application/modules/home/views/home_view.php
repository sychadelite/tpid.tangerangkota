  ...
  <div id="carouselHeroHome" class="carousel slide carousel-fade min-vh-100 w-100" data-mdb-ride="carousel" data-mdb-interval="2000" data-mdb-pause="false">
    ...
    <div class="carousel-inner min-vh-100">
      ...
      <div class="carousel-item min-vh-100 active">
        ...
        <img src="https://mdbcdn.b-cdn.net/img/Photos/Slides/img%20(15).webp" class="position-absolute d-block w-100 h-100" alt="Sunset Over the City" />
      ...
      <div class="carousel-item min-vh-100">
        ...
        <img src="/assets/pattern/circle.svg" class="overlay-pattern" alt="pattern-circle" />
        <img src="https://mdbcdn.b-cdn.net/img/Photos/Slides/img%20(22).webp" class="position-absolute d-block w-100 h-100" alt="Canyon at Nigh" />
        <div class="carousel-caption">
          <div class="caption-wrapper">
            <div>
              <div class="my-5">
              ...
              <button type="button" class="btn btn-warning btn-rounded mt-5 py-3 px-5 fs-6" data-mdb-ripple-color="dark">Cek Disini</button>
            </div>
            <div>
              <a href="#" class="icon-link"><img src="/assets/icons/instagram.svg" alt="instagram"></a>
              <a href="#" class="icon-link"><img src="/assets/icons/facebook.svg" alt="facebook"></a>
      ...
      <div class="carousel-item min-vh-100">
        ...
        <img src="/assets/pattern/circle.svg" class="overlay-pattern" alt="pattern-circle" />
        <img src="https://mdbcdn.b-cdn.net/img/Photos/Slides/img%20(23).webp" class="position-absolute d-block w-100 h-100" alt="Cliff Above a Stormy Sea" />
        <div class="carousel-caption">
          <div class="caption-wrapper">
            <div>
              <div class="my-5">
              ...
              <div class="card card-item text-white">
                ...
                <div class="card-img-overlay z-2">
                  <div class="d-flex flex-column justify-content-end h-100">
                    <h5 class="card-title"><span class="badge badge-primary">Kegiatan</span></h5>
                    <p class="card-text">
