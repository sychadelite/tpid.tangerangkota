  ...
  <div class="container-fluid px-5">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"><a href="#">Kegiatan <?php echo $month . " " . $year; ?></a></li>
      </ol>
    </nav>
  </div>
</nav>
                      ...
                      <div class="mt-n5">
                        <?php for ($k = 0; $k < 30; $k++) { ?>
                          <div class="position-relative d-flex flex-nowrap gap-5 w-100 fw-semibold">
                            ...
                            <div id="card-kegiatan<?= $k ?>" class="py-3 w-100">
                                  ...
                                  <div class="accordion" id="accordionPanelStayOpen<?= $k ?>">
                                    <div class="accordion-item border-0 text-white">
                                      ...
                                      <h2 class="accordion-header bg-primary-subtle" id="heading<?= $k ?>">
                                        <button onclick="refTo(`card-kegiatan<?= $k ?>`)" class="accordion-button collapsed from-before px-0 pb-2 bg-primary-subtle rounded-0" type="button" data-mdb-toggle="collapse" data-mdb-target="#panelStayOpenCollapse<?= $k ?>" aria-expanded="false" aria-controls="panelStayOpenCollapse<?= $k ?>">
