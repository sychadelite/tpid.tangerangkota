                ...
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-4">
                  <div class="col" style="max-width: 30rem;">
                    ...
                    <select class="form-select" style="padding: 12px;" id="tahun_kegiatan" name="tahun_kegiatan" aria-label="Default select example">
                      ...
                      <option value="1" <?php echo set_value('tahun_kegiatan') == '1' ? 'selected' : '' ?>>2018</option>
                      <option value="2" <?php echo set_value('tahun_kegiatan') == '2' ? 'selected' : '' ?>>2019</option>
                      <option value="3" <?php echo set_value('tahun_kegiatan') == '3' ? 'selected' : '' ?>>2020</option>
                      <option value="3" <?php echo set_value('tahun_kegiatan') == '3' ? 'selected' : '' ?>>2021</option>
                      <option value="3" <?php echo set_value('tahun_kegiatan') == '3' ? 'selected' : '' ?>>2022</option>
                      <option value="3" <?php echo set_value('tahun_kegiatan') == '3' ? 'selected' : '' ?>>2023</option>
                    </select>
                  ...
                  <div class="col" style="max-width: 30rem;">
                    ...
                    <select class="form-select" style="padding: 12px;" id="bulan_kegiatan" name="bulan_kegiatan" aria-label="Default select example">
                      ...
                      <option value="1" <?php echo set_value('bulan_kegiatan') == '1' ? 'selected' : '' ?>>Januari</option>
                      <option value="2" <?php echo set_value('bulan_kegiatan') == '2' ? 'selected' : '' ?>>Februari</option>
                      <option value="3" <?php echo set_value('bulan_kegiatan') == '3' ? 'selected' : '' ?>>Maret</option>
                      <option value="1" <?php echo set_value('bulan_kegiatan') == '1' ? 'selected' : '' ?>>April</option>
                      <option value="2" <?php echo set_value('bulan_kegiatan') == '2' ? 'selected' : '' ?>>Mei</option>
                      <option value="3" <?php echo set_value('bulan_kegiatan') == '3' ? 'selected' : '' ?>>Juni</option>
                      <option value="1" <?php echo set_value('bulan_kegiatan') == '1' ? 'selected' : '' ?>>Juli</option>
                      <option value="2" <?php echo set_value('bulan_kegiatan') == '2' ? 'selected' : '' ?>>Agustus</option>
                      <option value="3" <?php echo set_value('bulan_kegiatan') == '3' ? 'selected' : '' ?>>September</option>
                      <option value="1" <?php echo set_value('bulan_kegiatan') == '1' ? 'selected' : '' ?>>Oktober</option>
                      <option value="2" <?php echo set_value('bulan_kegiatan') == '2' ? 'selected' : '' ?>>November</option>
                      <option value="3" <?php echo set_value('bulan_kegiatan') == '3' ? 'selected' : '' ?>>Desember</option>
                    </select>
                          ...
                          <div class="mt-n5">
                            <?php for ($k = 0; $k < 3; $k++) { ?>
                              <div class="position-relative d-flex flex-nowrap gap-5 w-100 fw-semibold">
                                ...
                                <div id="card-kegiatan<?= $i . $j . $k ?>" class="py-3 w-100">
                                      ...
                                      <div class="accordion" id="accordionPanelStayOpen<?= $i . $j . $k ?>">
                                        <div class="accordion-item border-0 text-white">
                                          ...
                                          <h2 class="accordion-header bg-primary-subtle" id="heading<?= $i . $j . $k ?>">
                                            <button onclick="refTo(`card-kegiatan<?= $i . $j . $k ?>`)" class="accordion-button collapsed from-before px-0 pb-2 bg-primary-subtle rounded-0" type="button" data-mdb-toggle="collapse" data-mdb-target="#panelStayOpenCollapse<?= $i . $j . $k ?>" aria-expanded="false" aria-controls="panelStayOpenCollapse<?= $i . $j . $k ?>">
