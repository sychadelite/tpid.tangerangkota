  ...
  <div class="container-fluid px-2 px-sm-5">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"><a href="#">Pengumuman <?= $monthName . " " . $year ?></a></li>
      </ol>
    </nav>
  </div>
</nav>
            ...
            <div class="d-flex flex-column w-100">
              <div>
                <div class="title-frame px-5 px-sm-4" data-aos="fade-right" data-aos-duration="1000">
                  <h2>pengumuman <?= $monthName . " " . $year ?></h2>
                </div>
              ...
              <div class="position-relative p-3 w-100 min-vh-100">
                <form action="/pengumuman/group/event/search" method="post" autocomplete="off">
                ...
                <div class="position-relative d-flex flex-column justify-content-center align-items-start">
                  ...
                  <div class="position-relative w-100 px-3 px-sm-5">
                    ...
                    <div class="my-5">
                      ...
                      <div class="mt-n5">
                        <?php foreach ($content['data_pengumuman_by_year_month'] as $key => $row) { ?>
                          <div class="position-relative d-flex flex-nowrap gap-5 w-100 fw-semibold">
                            ...
                            <?php if ($key == count($content['data_pengumuman_by_year_month']) - 1) {
                                ...
                                <div class="accordion" id="accordionPanelStayOpen<?= $row->id ?>">
                                  <div class="accordion-item border-0 text-white">
                                    ...
                                    <h2 class="accordion-header bg-primary-subtle" id="heading<?= $row->id ?>">
                                      <button onclick="refTo(`card-pengumuman-<?= $row->id ?>`)" class="accordion-button collapsed from-before px-0 pb-2 bg-primary-subtle rounded-0" type="button" data-mdb-toggle="collapse" data-mdb-target="#panelStayOpenCollapse<?= $row->id ?>" aria-expanded="false" aria-controls="panelStayOpenCollapse<?= $row->id ?>">
