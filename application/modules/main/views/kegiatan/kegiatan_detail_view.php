  ...
  <div class="container-fluid px-2 px-sm-5">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"><a href="#"><?= $content['data_kegiatan_detail']->slug ?></a></li>
      </ol>
    </nav>
  </div>
</nav>
              ...
              <div class="position-relative d-flex flex-column align-items-center p-3 w-100 min-vh-100">
                <div class="news-content">
                  <div class="news-header w-100 text-center my-4">
                    <img src="<?= substr($content['data_kegiatan_detail']->cover, 1) ?>" class="w-100" alt="..." style="border-radius: 1rem;">
                  </div>
                  <div class="news-body my-4">
                    <h1 class="fs-3"><b><?= $content['data_kegiatan_detail']->title ?></b></h1>
                    <nav class="news-nav rounded-4">
                      <div class="d-flex flex-row flex-wrap align-items-center gap-2 mx-2 p-1">
                        <a href="#" class="d-flex flex-row align-items-baseline gap-1 text-reset">
                          ...
                          <small class="fw-bolder text-capitalize" style="font-size: 10px;"><?= $content['data_kegiatan_detail']->user_group_name ?></small>
                        </a>
                        <a href="#" class="d-flex flex-row align-items-baseline gap-1 text-reset">
                          <i class="fa-regular fa-clock fa-xs"></i>
                          <small class="fw-bolder" style="font-size: 10px;"><?= $content['data_kegiatan_detail']->created_at ?></small>
                        </a>
                      </div>
                    </nav>
                    <div class="news-text mt-2 fs-6 fw-medium">
                      <?= $content['data_kegiatan_detail']->description ?>
                    </div>
                  </div>
                </div>
              </div>
